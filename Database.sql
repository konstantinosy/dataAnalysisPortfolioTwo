...
INSERT INTO `actor_payment` (`Actor_Payment_ID`, `Actor_ID`, `Episode_ID`, `Actor_Payment_Amount`) VALUES
(1, 1, 2, 10000),
(2, 2, 3, 1500),
(3, 3, 4, 13000),
(4, 4, 13, 4500),
...
INSERT INTO `director_payment` (`Director_Payment_ID`, `Director_Payment_Amount`, `Series_ID`, `Director_ID`) VALUES
(1, 12000, 1, 1),
(2, 25045, 1, 2),
(3, 35000, 1, 3),
(4, 9250, 2, 7),
